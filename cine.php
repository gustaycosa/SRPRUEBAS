    ...
    <div class="container-fluid"> 
        <diV class="row">
            ...
            <diV class="col-sm-10 blue">
                ...
                <diV class="col-sm-1 red"></diV>
                palco
                <diV class="col-sm-1 col-sm-offset-5 red"></diV>
                <diV class="col-sm-1 red"></diV>
            </diV>
            <diV class="col-sm-1 blue">
        ...
        <diV class="row">
            ...
            <diV class="col-sm-10 blue">
                <diV class="col-sm-1 col-sm-offset-4 red"></diV>
                <diV class="col-sm-1 red"></diV>
                <diV class="col-sm-1 red"></diV>
                <diV class="col-sm-1 red"></diV>
                <diV class="col-sm-1 red"></diV>
        ...
        <diV class="row">
            ...
            <diV class="col-sm-10 blue">
                <diV class="col-sm-3 gray">diamante1</diV>
                <diV class="col-sm-3 col-sm-offset-6 gray">diamante2</diV>
            </diV>
            <diV class="col-sm-1 blue">
                <diV class="col-sm-12 red"></diV>
            </diV>
        ...
        <diV class="row">
            ...
            <diV class="col-sm-10 blue">
                <diV class="col-sm-1 red"></diV>
                <diV class="col-sm-1 col-sm-offset-10 red"></diV>
            </diV>
            <diV class="col-sm-1 blue">
                <diV class="col-sm-12 red"></diV>
            </diV>
        ...
        <diV class="row">
            ...
            <diV class="col-sm-10 blue">
                <diV class="col-sm-1 red"></diV>
                <diV class="col-sm-1 red"></diV>
                <diV class="col-sm-1 col-sm-offset-8 red"></diV>
                <diV class="col-sm-1 red"></diV>
            </diV>
            <diV class="col-sm-1 blue">
                <diV class="col-sm-12 red"></diV>
