 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'FECHA', 'width': '70px', 'targets': 1},
                { 'title': 'ARTICULO', 'width': '70px', 'targets': 2},
                { 'title': 'DESCRIPCION', 'width': '70px', 'targets': 3},
                { 'title': 'FACTURA ACTUAL','width': '70px', 'targets': 4},
                { 'title': 'CLIENTE', 'width': '70px', 'targets': 5},
                { 'title': 'SUBTOTAL', 'width': '70px', 'targets': 6}
            ],
