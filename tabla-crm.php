...
try{ 
    ...
    if ($_POST){
        ...
        $result = $WS->CRM_SELECT($parametros);
        $xml = $result->CRM_SELECTResult->any;
...
/*
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                { 'title': 'CASO', 'targets': 0},
                { 'title': 'FECHA', 'targets': 1},
                { 'title': 'CLIENTE', 'targets': 2},
                { 'title': 'GENERA', 'targets': 3},
                { 'title': 'TIPO', 'targets': 4},
                { 'title': 'DESCRIPCION', 'targets': 5},
                { 'title': 'ESTATUS', 'targets': 6}
            ],
