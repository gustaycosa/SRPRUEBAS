<div class="navmenu navmenu-default navmenu-fixed-left offcanvas">
  ...
  <ul class="nav navmenu-nav">
    ...
    -->
      <!--
    <li>
        <a href="Existencias.php" onclick="location.replace('');" type="button" class="list-group-item">
    ...
    -->
    <li>
        <a href="Vtasvendedores.php" type="button" class="list-group-item">
        <span class="glyphicon glyphicon-usd" aria-hidden="true"></span> 
            Ventas por vendedor
        </a>
    </li>
    <li>
        <a href="vtasxmecanico.php" type="button" class="list-group-item">
        <span class="glyphicon glyphicon-usd" aria-hidden="true"></span> 
            Ventas por mecanico
        </a>
    </li>
    <li>
        <a href="vtasserviciospreventivos.php" type="button" class="list-group-item">
        <span class="glyphicon glyphicon-usd" aria-hidden="true"></span> 
